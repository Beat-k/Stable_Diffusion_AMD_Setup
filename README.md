...
4. **Access the web interface**: http://127.0.0.1:7860

5. **Select ProtoGen X3.4** from the model dropdown and start creating!
...
| `Lightning_LoRA_Launcher.bat` | Interactive fast generation | 2-8 step Lightning LoRA modes |
| `SD_SYSTEM_CHECK.bat` | System diagnostics | Health checks and troubleshooting |
...
- 📋 **[Quick Summary](QUICK_SUMMARY.md)** - Settings reference
- 🔧 **[Troubleshooting](TROUBLESHOOTING_DIRECTML.md)** - Common issues and solutions
- 🎨 **[Model Guide](CIVITAI_GUIDE.md)** - Download and install more models

## 🎨 Available Models

### Pre-installed Models
- **ProtoGen X3.4 Photorealism** - High-quality photorealistic model (1.76GB)
- **SDXL Base 1.0** - Latest Stable Diffusion XL base model (6.46GB)
- **SDXL Refiner 1.0** - SDXL detail enhancement model (5.66GB)

### Lightning LoRA Modes

| Mode | Steps | Quality | Speed | Usage |
|------|-------|---------|-------|-------|
| Ultra-Fast | 2-3 | Good | ⚡⚡⚡ | Add `<lora:sdxl_lightning_2step_lora:0.9>` |
| Balanced | 4-6 | Better | ⚡⚡ | Add `<lora:sdxl_lightning_4step_lora:0.8>` |
| Quality | 8-10 | Best | ⚡ | Add `<lora:sdxl_lightning_8step_lora:0.8>` |

## 🔧 Key Optimizations

- ✅ DirectML environment configuration for AMD GPUs
- ✅ AMD-specific command line arguments
- ✅ Memory optimization for mid-range VRAM (8GB+)
- ✅ Removed CUDA dependencies completely
...
Steps: 20-30
Width/Height: 512x768 or 768x512
CFG Scale: 7-9
```
...
Sampling method: DPM++ 2M Karras
Steps: 20-35
Width/Height: 1024x1024 or 832x1216
CFG Scale: 6-8
```
...
4. **Lightning issues**: Use `Lightning_LoRA_Launcher.bat` interactive menu
